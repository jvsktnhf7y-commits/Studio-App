...
import { parentGetDashboard } from '../../services/api';
...
export default function ParentDashboardScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16, paddingBottom: 48 }}
      ...
      <LinearGradient colors={['#667eea', '#f093fb']} style={styles.hero} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
...
const styles = StyleSheet.create({
  ...
  balancePill:    { backgroundColor: 'rgba(255,255,255,0.2)', borderRadius: 14, padding: 14 },
